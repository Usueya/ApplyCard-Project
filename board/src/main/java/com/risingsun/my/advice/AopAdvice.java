package com.risingsun.my.advice;
...
public class AopAdvice {
	 ...
	 * 세번째 * : 메소드명, (..) : 매개변수
	 */
	@Before("execution(* com.risingsun.my.controller.*.*(..))")
	 ...
	 */
	@AfterReturning(pointcut = "execution(* com.risingsun.my.service.*.*(..))",
					returning = "rObj")
	 ...
	 */
	@AfterThrowing(pointcut = "execution(* com.risingsun.my.service.*.*(..))",
					throwing = "eObj")
