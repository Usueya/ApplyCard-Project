      ...
      <%@ include file="./include/header.jsp" %>
        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200" > 회원입회신청 </h2>
            	<form id="applyForm" action="${path}/apply" method="post">
					<table class="w-full whitespace-no-wrap" style="border: silver;">
						<tr style="height: 50px">
							...
							<td>
                				...
                				type="button" id="findApply">조회</button>
							</td>
						</tr>
						<tr>
							<th>신청일자</th>
